...
public class NavigationDrawerAdapter extends RecyclerView.Adapter<NavigationDrawerAdapter.ViewHolder> {
    ...
    int ICONS[] = {R.drawable.ic_home,R.drawable.ic_category,R.drawable.ic_my_topics,R.drawable.ic_thendral_audio,R.drawable.ic_about_us,R.drawable.ic_settings,R.drawable.ic_sign_out};
