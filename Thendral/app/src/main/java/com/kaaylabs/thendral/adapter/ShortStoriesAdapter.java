 ...
 */
public class ShortStoriesAdapter extends RecyclerView.Adapter<ShortStoriesAdapter.PersonViewHolder> {
    List<HomePageCenterClips> eventInformation;
    Activity context;
    Typeface tf_tamil_font;

    public ShortStoriesAdapter(List<HomePageCenterClips> eventInformation, Activity context) {
    ...
    public static class PersonViewHolder extends RecyclerView.ViewHolder {
        ...
        PersonViewHolder(View itemView) {
            ...
            uiContent = (TextView) itemView.findViewById(R.id.uicontent);
        }
    }
    ...
    public PersonViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.short_stories_childs_view, viewGroup, false);
    ...
    public void onBindViewHolder(PersonViewHolder personViewHolder, int i) {
        ...
        final int pos = i;
        String eventName = TamilUtil.convertToTamil(TamilUtil.BAMINI, eventInformation.get(i).getCategoryName());

        //Setting the new string to TextView
        personViewHolder.eventName.setText(eventName);
        DynamicImageView personPhoto_view = personViewHolder.personPhoto;
        Picasso.with(context).load("http://intimages.thendral.com.s3.amazonaws.com/hp/" + eventInformation.get(i).getThumbNailImage()).into(personPhoto_view);
        ...
        personViewHolder.eventDescription.setText(eventInformation.get(i).getHeadLine());
        personViewHolder.uiContent.setText(eventInformation.get(i).getAbstractContent());
